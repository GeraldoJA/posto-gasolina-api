...
public class VeiculoServiceTest {
	...
	private void testaCreateVeiculo() {
		...
		Veiculo v1 = new Veiculo(null, "Fiat", "Uno", "AAA111",10);
		this.veiculoService.create(v1);
		
		Veiculo v2 = new Veiculo(null, "Fiat", "Palio", "BBB2222", 20);
		this.veiculoService.create(v2);
		
		Veiculo v3 = new Veiculo(null, "Honda", "Civic", "CCC3333", 30);
		this.veiculoService.create(v3);
		
		Veiculo v4 = new Veiculo(null, "Peugeot", "408", "DDD4444", 40);
		this.veiculoService.create(v4);
		
		Veiculo v5 = new Veiculo(null, "Toyota", "Corola", "EEE5555", 50);
		this.veiculoService.create(v5);
		
		Veiculo v6 = new Veiculo(null, "Toyota", "Hilux", "FFF6666", 60);
